...
class AdapterUDPInterface:
    ...
    class __UDPInterface:
        ...
        def udp_recv(self):
            while True:
                udpmsg = self.socket.recvfrom(AdapterUDPInterface.RECVSIZE)
    ...
    def __init__(self):
        if not AdapterUDPInterface.instance:
            AdapterUDPInterface.instance = AdapterUDPInterface.__UDPInterface()
